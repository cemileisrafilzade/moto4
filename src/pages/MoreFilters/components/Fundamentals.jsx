...
import { Autocomplete, Checkbox, FormControl, FormControlLabel, MenuItem, Radio, RadioGroup, Select, TextField } from '@mui/material'
import { brands, cities, models, ownercount, seatCount, years } from '../../../mockData/mock'
  ...
  return (
    ...
    <div className={styles.dflex}>
      ...
      <Autocomplete
        ...
        options={ownercount}
        renderInput={(params) => (
          <TextField {...params} label="Sahib sayı" />
        )}
      />{" "}
      <Autocomplete
        className={styles.autocomplete}
